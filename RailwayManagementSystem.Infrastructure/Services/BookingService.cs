...
public class BookingService : IBookingService
{
    ...
    public async Task<ServiceResponse<TicketDto>> BookTicket(BookTicket bookTicket)
    {
        ...
        var passenger = await _passengerRepository.GetById(bookTicket.PassengerId);
    ...
    private Dictionary<Seat, List<Station>> GetBookedStationsForSeats(Trip trip, DateOnly tripDate)
    {
    ...
    private IEnumerable<Seat> GetAvailableSeats(Trip trip, DateOnly tripDate, Station startStation, Station endStation)
    {
    ...
    private IEnumerable<Station> GetStationsToBook(List<Station> stations, Station startStation, Station endStation)
    {
